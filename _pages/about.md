...
I have worked through Roman Vershynin's *High-Dimensional Probability: An Introduction with Applications
in Data Science*. Its non-asymptotic viewpoint (concentration of measure for sub-Gaussian and sub-exponential
random variables, Hoeffding- and Bernstein-type inequalities, ε-net and chaining arguments for suprema of random
processes, and sharp bounds on the extreme singular values of random matrices) is the language in which I think
about spectra of random designs and the detectability of low-rank structure in noise.
...
*Random matrix theory for parameter-efficient fine-tuning:* [details]({{ base_path }}/portfolio/01-lora-double-descent/)

**Machine Learning Research Intern**, MBZUAI, Abu Dhabi *(May 2025 – July 2025)*<br/>
Advisors: Prof. Jin Tian and Dr. Qiang Huang<br/>
*Causal inference under continuous and autoregressive treatments:* [details]({{ base_path }}/portfolio/02-causal-dose-response/)

See the [Research]({{ base_path }}/research/) page for all research projects, and
[Projects]({{ base_path }}/projects/) for engineering and course work.
